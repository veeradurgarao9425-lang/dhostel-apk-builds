      ...
      <View style={styles.section}>
        <View style={styles.overviewCard}>
          <View style={styles.overviewLeft}>
            ...
            <Text style={styles.overviewAmount}>{formatCurrency(outstandingDue)}</Text>
            <Text style={styles.overviewDate}>Months Due: {pendingFees.length}</Text>
      ...
      >
        {loading ? (
          ...
          <View style={styles.emptyWrap}>
            ...
            <Text style={styles.emptyBody}>Your monthly rent records will appear here once generated by the owner.</Text>
          </View>
        ) : activeTab === 'Dues' ? (
          <>
