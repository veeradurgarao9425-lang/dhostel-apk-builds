    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.message}>
          Your hostel's free trial or subscription plan has ended. All management features are temporarily locked. Please contact your hostel admin to renew their plan.
        </Text>
        <TouchableOpacity style={styles.button} onPress={() => alert('Please contact admin')}>
